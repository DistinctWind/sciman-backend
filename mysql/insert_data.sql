...
insert into subproject (project_id, principal_id, due_date, budget, tech_description) values
(1, 10001, '2024-06-15', 500000, '光伏发电设备优化研究'),
(1, 10001, '2024-08-31', 300000, '新型光伏材料研究'),
(2, 10002, '2024-07-20', 400000, '社会网络分析工具开发'),
(2, 10002, '2024-09-15', 400000, '社会结构演化模型构建'),
(3, 10003, '2024-07-01', 800000, '大气环境模拟软件开发'),
(3, 10003, '2024-09-30', 400000, '大气环境变化模拟实验'),
(4, 10004, '2024-06-30', 750000, '地震活动规律分析'),
(4, 10004, '2024-08-15', 750000, '地震发生时间和地点预测算法优化'),
(5, 10005, '2024-07-10', 1000000, '光电子器件制造工艺研究'),
(5, 10005, '2024-09-25', 1000000, '光电子器件应用技术实验'),
(6, 10006, '2024-07-05', 500000, '音乐艺术与声学技术融合研究'),
(6, 10006, '2024-09-20', 500000, '声学技术在音乐创作中的应用'),
(7, 10007, '2024-07-25', 750000, '智能机器人制造工艺研究'),
(7, 10007, '2024-09-10', 750000, '智能机器人应用场景开发');
