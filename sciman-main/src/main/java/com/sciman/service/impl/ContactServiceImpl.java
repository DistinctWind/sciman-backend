...
public class ContactServiceImpl implements ContactService {
    ...
    private final SecondaryContactMapper secondaryContactMapper;

    @Override
    public boolean addContact(Contact contact, Long organizationId) {
        contactMapper.addContact(contact);
        return secondaryContactMapper.addSecondaryContact(contact.getId(), organizationId) == 1;
    }
